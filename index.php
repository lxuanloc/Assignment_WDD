	  ...
	  <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
	          		  <a class="nav-link" href="login.php"button> Login</a>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	    <div class="item active">
	      <img src="https://bizweb.dktcdn.net/100/345/407/themes/706150/assets/slider_1.png?1622449624938" alt="Slide 1">
	    </div>

	    <div class="item">
	      <img src="https://bizweb.dktcdn.net/100/345/407/themes/706150/assets/slider_2.png?1622449624938" alt="Slide 2">
	    </div>

	    <div class="item">
	      <img src="https://bizweb.dktcdn.net/100/345/407/themes/706150/assets/slider_4.png?1622449624938" alt="Slide 3">
	    </div>
	  </div>
...
<div class="container">
	<div class="row mt-5">
		...
		<div class="list-product-subtitle">
			...
			<?php
				$query = "SELECT * FROM tbl_product ORDER BY id ASC LIMIT 9 OFFSET 0";
